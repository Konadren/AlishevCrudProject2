# AlishevCrudProject2
Выполнение задания Алишева (создание crud-приложения) с использованием Spring Data JPA

Задача:
==============================================================
Переписать Проект 1 (https://github.com/Konadren/AlishevCrudProject) с использованием Hibernate и Spring Data JPA. В вашем
